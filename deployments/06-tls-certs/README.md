# Lab 06: TLS Certificate Generation
...
2. **Server Certificate** — for the server (minikube ingress)
...
openssl req -new -nodes -out server.csr -keyout server.key -subj "/CN=myapp.com"
...
- Add `SAN` (Subject Alternative Names) for multiple domains: `-addext "subjectAltName=DNS:myapp.com,DNS:*.myapp.com"`
